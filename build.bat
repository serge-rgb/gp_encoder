...
pushd build
cl /nologo /FC /Wall /WX /Zi /O2 /fp:fast %includes% %defines% %suppressed% ..\src\jpeg_test.c OpenCL.lib
cl /nologo /FC /Wall /WX /Zi /Od /fp:fast %includes% %defines% %suppressed% ..\src\evolve_CPU.c ..\src\extended_jpeg.c OpenCL.lib
popd
