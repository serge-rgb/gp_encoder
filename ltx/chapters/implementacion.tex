...
%         \hline
%         Nombre &  Un Hilo & Multihilo & GPU & Aceleración MT & Aceleración GPU \\
%         \hline
...
Se tiene entonces una matriz $A$ cuyos elementos tienen 7 posibles valores y sus negativos:
...
El kernel de DummyJPEG no puede hacer mucho para evitar que haya \emph{wavefronts}
...
\begin{figure}[h]
    ...
    \caption{Mala predicción de salto}
    \label {fig:mispred}
\end{figure}
...
mala predicción, pero se puede atacar al problema como si fuera un problema de
mala predicción. Si se hace más rápido, entonces suponemos que el problema era
el salto.
...
% TO-DO otro pantallazo
\begin{figure}[hb]
    \includegraphics[width=5.16666in]{round_fast}
    \caption{Evitando mala predicción}
\end{figure}
