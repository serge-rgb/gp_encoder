...
Para múltiples \emph{ threads }, se utilizan \emph{ threads } trabajadores que consumen unidades
...
\emph{ threads }, y GPU. Para un conjunto de imágenes de prueba, la tabla
