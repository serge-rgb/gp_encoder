...
% ****************************************************************************************************
\newcommand{\myTitle}{Paralelización de Meta-heurísticas Bio-inspiradas.\xspace}
\newcommand{\mySubtitle}{Un estudio comparativo del rendimiento entre CPUs y GPUs en Optimización Paramétrica.\xspace}
\newcommand{\myDegree}{B.Sc. in Computer Science\xspace}
\newcommand{\myName}{Rodrigo González del Cueto\xspace}
...
\newcommand{\myTime}{Enero 2013\xspace}
...
\hypersetup{%
  ...
  pdfauthor={Rodrigo González del Cueto},
  pdfsubject={B.Sc Thesis},
  pdftitle={Paralelización de Meta-heurísticas Bio-inspiradas: Un estudio comparativo del rendimiento entre CPU y GPU en optimización paramétrica},
  pdfkeywords={Paralelización, Metaheurísticas, Bioinspiradas, Cómputo, Evolutivo, Algoritmos Genéticos, Enjambre de partículas, PSO, Evolución Diferencial, GPGPU, CUDA, GPU, OpenMP, Multithread, Massively Parallel}
}
