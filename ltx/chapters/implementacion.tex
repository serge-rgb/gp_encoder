...
% Describir el método de ataque para implementar en el CPU
Antes de escribir el kernel,

Se llama \emph{una sóla vez} para todos los bloques, en el caso de un sólo
