...
% ****************************************************************************************************
\newcommand{\myTitle}{Evolución de Tablas de Cuantización para Codificadores JPEG.\xspace}
\newcommand{\mySubtitle}{Diseño e implementación de un compresor y su correspondiente algoritmo evolutivo para encontar la calidad óptima.\xspace}
