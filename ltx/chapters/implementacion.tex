...
condicional. Es útil usar referencias oficiales \cite{maxwell-tuning}, pero los
recursos gratis, como GPU Tech Conf \cite{gtc}, una conferencia anual sobre
GPUs, son una buena fuente de información para aprender a obtener el mayor
desempeño
