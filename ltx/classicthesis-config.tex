...
\newcommand{\mySubtitle}{Diseño e implementación de un algoritmo evolutivo paralelo\xspace}
...
\PassOptionsToPackage{spanish,es-tabla,es-lcroman,american}{babel}
\usepackage{babel}
\spanishdecimal{.}
...
\hypersetup{%
  ...
  pdftitle={Sergio González - Tesis},
  pdfkeywords={}
}
