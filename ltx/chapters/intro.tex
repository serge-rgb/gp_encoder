...
compresión de imágenes \cite{JPEGSTD}. El formato JPEG, soportando varios
...
Dado que las computadoras son mcho más rápidas de lo que eran en los 90s, y
...
La especificación JPEG \cite{JPEGSTD} incluye matrices de ejemplo, pero la
